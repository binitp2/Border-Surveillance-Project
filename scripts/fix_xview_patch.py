...
TARGET = Path(
    "/home/binitpatel/Workspace/Border Surveillance Project/scripts/preprocess_local.py")

# Also check root if scripts/ copy doesn't exist
if not TARGET.exists():
    TARGET = Path(
        "/home/binitpatel/Workspace/Border Surveillance Project/preprocess_local.py")
