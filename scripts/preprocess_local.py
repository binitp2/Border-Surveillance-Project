...
def print_summary():
    ...
    print(
        f'     yolo train model=yolov8n.pt data="{DATA_OUT}/data.yaml" epochs=50 imgsz=640')
...
if __name__ == "__main__":
    ...
    print(
        f"  UCF-Crime frames : {UCF_FRAMES} {'✅' if UCF_FRAMES.exists() else '❌ NOT FOUND'}")
    print(
        f"  xView extracted  : {XVIEW_DIR}  {'✅' if XVIEW_DIR.exists() else '❌ NOT FOUND'}")
